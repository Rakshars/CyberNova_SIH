        ...
        <aside className="card" style={{ padding: 20 }}>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '13px', cursor: 'pointer', color: categoryParam === 'All' ? '#fff' : 'var(--text-sub)' }}>
                <input 
                  type="radio" 
                  name="category" 
              ...
              {categories.map(cat => (
                <label key={cat.id} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '13px', cursor: 'pointer', color: categoryParam === cat.name ? '#fff' : 'var(--text-sub)' }}>
                  <input 
                    type="radio" 
                    name="category" 
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {['All', 'Beginner', 'Intermediate', 'Advanced'].map(diff => (
                <label key={diff} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '13px', cursor: 'pointer', color: difficultyParam === diff ? '#fff' : 'var(--text-sub)' }}>
                  <input 
                    type="radio" 
                    name="difficulty" 
        ...
        <section style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 4px', flexWrap: 'wrap', gap: 12 }}>
            <span style={{ fontSize: '13px', color: 'var(--text-sub)' }}>
              Found <strong style={{ color: '#fff' }}>{totalResults}</strong> matching topics
          ...
          {loading ? (
            ...
            <>
              ...
              {totalPages > 1 && (
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 12, marginTop: 24, paddingBottom: 24 }}>
                  ...
                  <span style={{ fontSize: '13px', color: 'var(--text-sub)' }}>
                    Page <strong style={{ color: '#fff' }}>{pageParam}</strong> of {totalPages}
                  </span>
                  <button
                    type="button"
            ...
            >
              ...
              <div>
                <h4 style={{ color: '#fff', fontSize: '18px', fontWeight: 700, margin: '0 0 8px' }}>
